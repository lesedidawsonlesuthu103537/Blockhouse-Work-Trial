import csv
# Reading the data in
with open("PFE_raw_data.csv","r") as csvfile:
...
temp.to_csv("PFE_OFI.csv")
int_ofi_dat=pd.DataFrame(int_ofi)
int_ofi_dat.to_csv("PFE_INT_OFI2.csv")
