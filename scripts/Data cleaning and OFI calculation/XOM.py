import csv
with open("XOM_raw_data.csv","r") as csvfile:
...
temp.to_csv("XOM_OFI.csv")
int_ofi_dat=pd.DataFrame(int_ofi)
int_ofi_dat.to_csv("XOM_INT_OFI2.csv")
